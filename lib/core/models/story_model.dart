...
class StoryModel {
  ...
  factory StoryModel.fromMap(Map<String, dynamic> map, String documentId) {
    return StoryModel(
      ...
      publishedAt: map['publishedAt'] != null ? (map['publishedAt'] is String ? DateTime.tryParse(map['publishedAt']) ?? DateTime.now() : (map['publishedAt'] as Timestamp).toDate()) : DateTime.now(),
      verifiedAt: map['verifiedAt'] != null ? (map['verifiedAt'] is String ? DateTime.tryParse(map['verifiedAt']) : (map['verifiedAt'] as Timestamp).toDate()) : null,
